    ...
    <div style={styles.page}>
      <div style={styles.pinBox}>
        ...
        <p style={styles.setPinHelp}>
          {mode === 'reset'
            ? 'Enter your Restora password to authorise the reset, then choose a new 4–6 digit PIN. The old PIN on this terminal is replaced; the password itself is never stored here.'
            : "Prove it's you with your Restora password, then pick a 4–6 digit PIN you'll use on this terminal. The password is never stored here."}
        </p>
