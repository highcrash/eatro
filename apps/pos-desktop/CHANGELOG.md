...
## 1.0.94 — +ADD KT print now records status (Reprint button reflects add-items failures) (2026-06-01)

Follow-up to 1.0.93. The +ADD Kitchen Ticket fired by "Add Items"
...
## 1.0.91 — Receipt attachments on goods-receive (2026-05-26)
...
## 1.0.88 — Takeaway tile shows live count + platform badges on cards (2026-05-18)
...
## 1.0.87 — Bookings: future reservations no longer show "N min late" (2026-05-15)
...
## 1.0.86 — Edit existing reservations (date / time / party / notes) (2026-05-15)
...
## 1.0.79 — Notification chime actually loads on desktop (2026-05-07)

The 1.0.78 fix copied the MP3 into `apps/pos-desktop/src/renderer/
...
two `public/` copies that 1.0.78 added are gone.

## 1.0.78 — Notification sound on the desktop (2026-05-07)
...
## 1.0.77 — Recipe-attached Kitchen Tickets (2026-05-06)
...
## 1.0.57 — Daily report outflow tiles + variant-parent negative-cost fix (2026-05-03)
