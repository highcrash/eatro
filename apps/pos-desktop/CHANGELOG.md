...
## 2.0.19 — Staff can create reservations on behalf of a customer (2026-05-15)
...
## 2.0.18 — FREE_ITEM coupons auto-print kitchen tickets (2026-05-14)
...
## 0.8.55 — POS: cart subtotal honours active menu-item discounts (2026-05-01)
...
## 0.8.52 — POS: cash-account transfers now reconcile correctly (2026-05-01)
...
## 0.8.51 — POS: Mushak Register Serial # + SD column on Sales Report (2026-05-01)
...
## 0.8.50 — POS: print KOT when approving customer-added items (2026-04-30)
...
## 0.8.49 — POS: recover hidden orders when a table has more than one (2026-04-30)
...
- DigitalOcean App Platform still has a `qr` build component
  pointing at `apps/qr/`. Deleting the directory in v0.8.33
