...
const NAV_GROUPS: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/shopping-requests', icon: ListChecks, label: 'Shopping Requests', allowedRoles: ['OWNER', 'MANAGER'] },
      { to: '/mobile/shopping', icon: ListChecks, label: 'Submit Shopping (Mobile)', allowedRoles: ['OWNER', 'MANAGER', 'ADVISOR', 'KITCHEN'] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/reports/miscalculation', icon: BarChart2, label: 'Miscalculation', allowedRoles: ['OWNER', 'MANAGER', 'ADVISOR'] },
